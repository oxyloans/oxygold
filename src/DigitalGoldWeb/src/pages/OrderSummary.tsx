      ...
      <div className="page">
        <section className="ro-topbar">
          <div className="ro-topbar-in">
            ...
            <span className="ro-topbar-title">Order Summary</span>
            <span className="ro-topbar-sep" />
            <span className="ro-topbar-sub">Review your order details</span>
          </div>
        </section>
        ...
        <main className="main">
          <div className="card">
            ...
            <p className="content">Order summary details will be displayed here.</p>
          </div>
        </main>
      </div>
    </>
