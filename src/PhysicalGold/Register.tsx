...
import { loginOrRegister, createRole } from './physicalGoldService';
...
const Register = () => {
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      ...
      localStorage.setItem('user', JSON.stringify({ phone, isLoggedIn: true, token, role: selectedRole, ...data }));

      try {
        await createRole(selectedRole);
      } catch (roleErr) {
        console.error("Role creation failed:", roleErr);
        // We might still proceed if user is already registered or role exists
      }
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .rg-back:hover { color: #888; border-color: #d4cec6; }
          ...
          <div className="rg-left">
            ...
            <div className="rg-left-content">
              <div className="rg-logo-mark">
                ...
                <span className="rg-logo-name">OxyGold</span>
              </div>
              <div className="rg-left-bottom">
                <div className="rg-tagline">Invest in<br /><em>Digital gold,</em><br />digitally.</div>
                <div className="rg-left-desc">Join thousands of smart investors growing wealth with digital gold.</div>
                <div className="rg-perks">
                  <div className="rg-perk">
                    <div className="rg-perk-icon">✓</div>
                    <span className="rg-perk-txt">Buy from as little as ₹1</span>
                  </div>
                  <div className="rg-perk">
                    <div className="rg-perk-icon">✓</div>
                    <span className="rg-perk-txt">100% insured & securely stored</span>
                  </div>
                  <div className="rg-perk">
                    <div className="rg-perk-icon">✓</div>
                    <span className="rg-perk-txt">Sell anytime, instant payout</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {step === 'phone' && (
              <div className="rg-animate">
                ...
                <div className="rg-footer">
                  ...
                  <button className="rg-link" onClick={() => navigate('/login')}>Sign in</button>
                </div>
                <button className="rg-back" onClick={() => navigate('/physical-gold')}>← Back to store</button>
              </div>
            )}
