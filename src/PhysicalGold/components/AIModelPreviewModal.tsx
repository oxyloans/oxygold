...
import { X, Download, RefreshCw, AlertCircle, Loader2 } from "lucide-react";

interface AIModelPreviewModalProps {
  isOpen: boolean;
  onClose: () => void;
...
const AIModelPreviewModal: React.FC<AIModelPreviewModalProps> = ({
  isOpen,
  onClose,
  isGenerating,
  generatedImage,
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-[#8A8A8A] font-medium">
                See how this jewellery looks on a model
              </p>
            </div>
          </div>
          <button
            ...
            <div className="flex flex-col items-center justify-center py-20 space-y-6">
              ...
              <div className="text-center space-y-2">
                ...
                <p className="text-[13px] text-[#8A8A8A] max-w-md leading-relaxed">
                  Please wait while our AI creates a realistic preview of this jewellery on a professional model. This usually takes 40-50 seconds.
                </p>
              </div>
              {/* Progress dots */}
...
export default AIModelPreviewModal;
