    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .lg-back:hover { color: #888; border-color: #d4cec6; }
          ...
          <div className="lg-left">
            ...
            <div className="lg-left-content">
              <div className="lg-logo-mark">
                ...
                <span className="lg-logo-name">OxyGold</span>
              </div>
              <div>
                <div className="lg-tagline">Invest in<br /><em>pure gold,</em><br />digitally.</div>
                <div className="lg-left-desc">Buy, sell, and hold 24K gold securely from your phone.</div>
                <div className="lg-stats">
                  ...
                  <div className="lg-stat">
                    <span className="lg-stat-val">₹1</span>
          ...
          <div className="lg-right">
            ...
            {step === 'phone' && (
              <div className="lg-animate">
                ...
                <button className="lg-back" onClick={() => navigate('/physical-gold')}>← Back to store</button>
              </div>
            )}
