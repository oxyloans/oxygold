...
const PartnerRegister = () => {
  ...
  const handleSendOtp = async () => {
    ...
    setLoading(true);
    try {
      const data = await partnerService.loginOrRegister({
        phoneNumber: phone,
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      ...
      localStorage.setItem('partner', JSON.stringify({ phone, isLoggedIn: true, token, role: 'partner', ...data }));

      try {
        await partnerService.createRole('partner');
      } catch (roleErr) {
          ...
          <div className="rg-left">
            ...
            <div className="rg-left-content">
              <div className="rg-logo-mark">
                ...
                <span className="rg-logo-name">OxyGold Partner</span>
              </div>
              <div className="rg-left-bottom">
                <div className="rg-tagline">Join the<br /><em>Partner team,</em><br />digitally.</div>
                <div className="rg-left-desc">Register as an partneristrator to manage the OxyGold platform.</div>
              </div>
            </div>
          </div>
          ...
          <div className="rg-right">
            ...
            {step === 'phone' && (
              <div className="rg-animate">
                <div className="rg-form-title">Create Partner account</div>
                ...
                <div className="rg-footer">
                  Already an partner?{' '}
                  <button className="rg-link" onClick={() => navigate('/partner/login')}>Sign in</button>
                </div>
              </div>
            )}
