...
const PartnerLogin = () => {
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      ...
      localStorage.setItem('partner', JSON.stringify({ phone, isLoggedIn: true, ...data }));
          ...
          <div className="lg-left">
            ...
            <div className="lg-left-content">
              <div className="lg-logo-mark">
                ...
                <span className="lg-logo-name">OxyGold Partner</span>
              </div>
              <div>
                <div className="lg-tagline">Manage your<br /><em>gold catalog</em><br />seamlessly.</div>
                <div className="lg-left-desc">Partner portal for OxyGold physical gold and digital assets.</div>
              </div>
            </div>
          </div>
          ...
          <div className="lg-right">
            ...
            {step === 'phone' && (
              <div className="lg-animate">
                <div className="lg-form-title">Partner Sign In</div>
                ...
                <div className="lg-footer">
                  No partner account?{' '}
                  <button className="lg-link" onClick={() => navigate('/partner/register')}>Register</button>
                </div>
              </div>
            )}
