...
const VideoCreationPage: React.FC = () => {
  ...
  // Auto-generate video on component mount if context exists
  useEffect(() => {
    const userContextRaw = sessionStorage.getItem("userJewelryContext");
    if (userContextRaw && !hasAutoGenerated && !loading) {
      setHasAutoGenerated(true);
      setTimeout(() => {
        handleVideoCreation("Create a beautiful jewelry video for me");
      }, 100);
    }
          ...
          {messages.length === 0 && !loading && (
            <div className="text-center py-16 animate-fade-in">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-w-4xl mx-auto">
                {[
                  "Design a cinematic gold jewellery video for a wedding occasion.",
                  "Create a luxury slow-motion video of a gold ring being worn.",
                  "Generate a royal gold necklace styling video under warm golden lighting.",
                  "Show a modern minimal gold jewellery look in a premium studio setting.",
                ].map((prompt, index) => (
                  <button
                    key={index}
            ...
            <div className="text-center py-16 animate-fade-in">
              <div className="flex flex-col items-center gap-4">
                ...
                <h2 className="text-2xl font-bold text-black dark:text-white">
                  Creating Your Personalized Jewelry Video
                </h2>
                <p className="text-gray-700 dark:text-gray-200 max-w-md">
                  Using your preferences to generate the perfect jewelry video...
                </p>
              </div>
            </div>
          )}
                ...
                >
                  ...
                  >
                    ...
                    {msg.videoId && msg.isCreating && (
                      <div className="mt-4 p-4 rounded-xl bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-600">
                        ...
                        <div className="text-xs text-black dark:text-white">
                          Video ID:{" "}
                          <span className="font-mono px-2 py-1 rounded bg-gray-200 dark:bg-gray-700">
                            {msg.videoId}
                          </span>
                        </div>
                      </div>
