...
const ImageCreation: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (userContextRaw && !hasAutoGenerated && !loading) {
    ...
    <div className="h-screen flex flex-col">
        ...
        <div className="max-w-5xl mx-auto px-6 py-8">
          ...
          {messages.length === 0 && !loading && (
            <div className="text-center py-16 animate-fade-in">
              ...
              <p className="text-lg text-gray-700 dark:text-gray-200 mb-12 max-w-2xl mx-auto leading-relaxed">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-w-4xl mx-auto">
                {EXAMPLE_PROMPTS.map((prompt, index) => (
                  <button
                    ...
                    className="p-3 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-600 hover:shadow-md hover:border-black dark:hover:border-white transition-all text-left group animate-slide-up"
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <p className="text-gray-800 dark:text-gray-200 text-sm leading-snug transition-colors group-hover:text-black dark:group-hover:text-white">
                        {prompt}
                      </p>
                    </div>
                  </button>
      ...
      <div className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-lg border-t border-gray-200 dark:border-gray-800 p-3 shadow-2xl flex-shrink-0">
        <div className="max-w-5xl mx-auto">
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-300 dark:border-gray-600 shadow-lg focus-within:ring-2 focus-within:ring-black dark:focus-within:ring-white transition-all">
