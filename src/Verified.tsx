...
const certificatePreviewUrl =
    "https://drive.google.com/file/d/1UfumVer6wyPprtGJI75Q-EkXjxR65CLI/preview";
...
function Icon({
    ...
    const paths: Record<IconName, ReactNode> = {
        ...
        shield: (
            <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10Zm-3.2-9.5 2.1 2.1 4.5-5" />
        ),
        scale: (
            <>
...
const identityDetails = [
...

    {
        ...
        value: silverRecord.weightTolerance,
        icon: "check" as IconName,
    },
    {
        label: "BIS Standard",
        value: silverRecord.bisStandard,
        icon: "document" as IconName,
    },
    {
        label: "HUID",
        value: silverRecord.huid,
        icon: "fingerprint" as IconName,
        pending: true,
    },
    {
        label: "BIS Hallmark Registration No.",
        value: silverRecord.bisRegistration,
        icon: "shield" as IconName,
    },

    {
        label: "OXY Trace ID",
        value: silverRecord.traceId,
        icon: "fingerprint" as IconName,
    },
];
...
const journey = [
    ...
    },
    {
        ...
        description:
            "The declared manufacturing partner responsible for the finished article.",
    ...
    },
    {
        ...
        description:
            "The hallmark and item HUID connect the physical article to its official identity.",
        icon: "fingerprint" as IconName,
    },
    {
        step: "04",
        ...
        description:
            "The legal owner responsible for this OXYGOLD.AI trace record.",
...
export default function Home() {
    ...
    return (
        <main className="min-h-screen overflow-hidden bg-[#07090b] text-[#f5f2ea] selection:bg-amber-300 selection:text-black">
            ...
            <section
                id="top"
                className="relative z-10 mx-auto max-w-7xl px-5 pb-16 pt-14 sm:px-8 sm:pt-20 lg:px-12 lg:pb-24"
            >
                <div className="grid items-center gap-12 lg:grid-cols-[1.12fr_0.88fr] lg:gap-16">
                    <div>
                        ...
                        <p className="mb-4 text-xs font-bold uppercase tracking-[0.32em] text-amber-300/80">
                        ...
                        <p className="mt-7 max-w-2xl text-base leading-8 text-white/62 sm:text-lg">
                            You scanned the QR linked to this silver article. This digital
                            passport presents its declared purity, hallmark identity,
                            ownership and chain of custody in one transparent record.
                        </p>
                        ...
                        <div className="relative overflow-hidden rounded-[2rem] border border-amber-300/30 bg-gradient-to-br from-[#1a1c1f] via-[#0e1012] to-black p-6 shadow-[0_40px_100px_rgba(0,0,0,0.45)] sm:p-8">
                            ...
                            <div className="flex items-start justify-between gap-4">
                                <div>
                                    <p className="text-[10px] font-bold uppercase tracking-[0.28em] text-white/40">
                                        Digital silver passport
                                    </p>
                                    <p className="mt-2 font-serif text-2xl text-amber-300">
                                        {silverRecord.brand}
                                    </p>
                                </div>
                            ...
                            <div className="my-9 flex justify-center">
                                <div className="relative grid h-48 w-48 place-items-center rounded-full border border-white/30 bg-[radial-gradient(circle_at_32%_25%,#ffffff_0%,#d3d6d8_18%,#8b9195_45%,#e8e9e9_65%,#73777a_100%)] p-2 shadow-[0_28px_80px_rgba(0,0,0,0.6),inset_0_0_18px_rgba(255,255,255,0.8)] sm:h-56 sm:w-56">
                                    ...
                                    <div className="relative text-center text-[#1b1d1e]">
                                        <span className="block font-serif text-5xl font-black">
                                            Ag
                                        </span>
                                        <span className="mt-2 block text-sm font-extrabold tracking-[0.2em]">
                                            999.9
                                        </span>
                                        <span className="mt-1 block text-[8px] font-bold uppercase tracking-[0.24em]">
                                            Fine Silver
                                        </span>
                                    </div>
                                </div>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-4">
                                    ...
                                    <p className="mt-2 break-words font-mono text-xs text-white/85">
                                        {silverRecord.traceId}
                                    </p>
                                </div>
            ...
            <section className="relative z-10 border-y border-white/10 bg-white/[0.025]">
                <div className="mx-auto grid max-w-7xl grid-cols-2 divide-x divide-white/10 px-5 sm:px-8 lg:grid-cols-4 lg:px-12">
                    {[
                        ...
                        <div
                            key={label}
                            className="px-4 py-6 text-center even:border-l-0 sm:py-7 lg:px-6"
                        >
            ...
            <section
                id="identity"
                className="relative z-10 mx-auto max-w-7xl scroll-mt-24 px-5 py-20 sm:px-8 lg:px-12 lg:py-28"
            >
                <div className="max-w-3xl">
                    <p className="text-xs font-bold uppercase tracking-[0.3em] text-amber-300/75">
                        01 — Item identity
                    </p>
                    ...
                    <p className="mt-5 text-base leading-8 text-white/55">
                        The product details connected to this QR record. Fields marked
                        “Pending entry” must be updated with the final value before the QR
                ...
                <div className="mt-11 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
                    {identityDetails.map((item) => (
                        <article
                            key={item.label}
                            className="group min-h-40 rounded-3xl border border-white/10 bg-gradient-to-br from-white/[0.06] to-white/[0.02] p-5 transition hover:-translate-y-1 hover:border-amber-300/25"
                        >
                            <div className="flex items-center justify-between">
                                ...
                                {item.pending ? (
                                    <span className="rounded-full border border-amber-300/20 bg-amber-300/[0.07] px-2.5 py-1 text-[8px] font-bold uppercase tracking-[0.14em] text-amber-200">
                                        Pending entry
                                    </span>
                                ) : (
                            ...
                            <p className="mt-6 text-[10px] font-bold uppercase tracking-[0.18em] text-white/35">
                                {item.label}
                            </p>
                            <p
                                className={`mt-2 break-words text-sm font-semibold leading-6 ${item.pending ? "text-amber-100/75" : "text-white/90"}`}
                            >
                                {item.value}
                            </p>
                        </article>
                    ...
                    <div className="grid gap-12 lg:grid-cols-[0.72fr_1.28fr] lg:gap-20">
                        <div className="lg:sticky lg:top-24 lg:self-start">
                            ...
                            <p className="mt-6 text-base leading-8 text-white/55">
                                A clear account of the parties connected to this silver article.
                                Each stage supports accountability and customer confidence.
                            </p>
                        </div>
                        ...
                        <div className="relative space-y-4 before:absolute before:bottom-10 before:left-7 before:top-10 before:w-px before:bg-gradient-to-b before:from-amber-300/50 before:via-white/15 before:to-transparent">
                            {journey.map((item) => (
                                <article
                                    key={item.step}
                                    className="relative flex gap-5 rounded-3xl border border-white/10 bg-white/[0.035] p-5 sm:gap-6 sm:p-6"
                                >
                                    ...
                                    <div className="min-w-0 pt-1">
                                        <p className="text-[9px] font-bold uppercase tracking-[0.22em] text-amber-300/55">
                                            Stage {item.step} · {item.label}
                                        </p>
                                        <h3 className="mt-2 break-words text-lg font-bold text-white sm:text-xl">
                                            {item.value}
                                        </h3>
            ...
            <section className="relative z-10 mx-auto max-w-7xl px-5 py-20 sm:px-8 lg:px-12 lg:py-28">
                <div className="grid overflow-hidden rounded-[2rem] border border-white/10 bg-gradient-to-br from-[#18191a] via-[#101214] to-[#090a0b] shadow-[0_30px_80px_rgba(0,0,0,0.35)] lg:grid-cols-[0.92fr_1.08fr]">
                    <div className="relative overflow-hidden border-b border-white/10 p-6 sm:p-8 lg:min-h-full lg:border-b-0 lg:border-r lg:p-10">
                        ...
                        <div className="relative flex h-full min-h-[22rem] flex-col justify-between gap-5">
                            <div className="flex items-start justify-between gap-3">
                                <span className="rounded-full border border-amber-300/25 bg-amber-300/[0.08] px-3 py-1.5 text-[9px] font-bold uppercase tracking-[0.2em] text-amber-200">
                                    Founder profile
                                </span>
                                <div className="grid h-10 w-10 place-items-center rounded-full border border-white/10 bg-white/[0.04] text-white/35 shadow-inner shadow-white/5">
                            ...
                            <div className="flex flex-1 flex-col items-center justify-center text-center sm:items-start sm:text-left">
                                <div className="relative mb-5">
                                    ...
                                    <div className="relative overflow-hidden rounded-full border border-amber-300/35 bg-gradient-to-br from-[#f8d88c] via-[#c88f2f] to-[#4d2b0d] p-2 shadow-[0_20px_50px_rgba(0,0,0,0.35)]">
                                        <img
                                            ...
                                            className="h-40 w-40 rounded-full object-cover object-center sm:h-48 sm:w-48 lg:h-56 lg:w-56"
                                        />
                                    </div>
                                </div>
                                ...
                                <p className="mt-3 max-w-md font-serif text-lg italic leading-relaxed text-amber-300 sm:text-xl">
                                    “{silverRecord.founderNote}”
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="p-6 sm:p-8 lg:p-12">
                        <p className="text-xs font-bold uppercase tracking-[0.3em] text-amber-300/75">
                            03 — People & responsibility
                        </p>
                        <h2 className="mt-4 font-serif text-3xl tracking-tight text-white sm:text-4xl lg:text-5xl">
                            Trust has a name behind it.
                        </h2>
                        <p className="mt-6 max-w-2xl text-sm leading-7 text-white/58 sm:text-base sm:leading-8">
                            This trace record identifies the founder and the legal owner
                            associated with OXYGOLD.AI. It is designed to help every customer
                            understand who stands behind the silver they receive.
                        </p>
                        <div className="mt-8 grid gap-4 sm:grid-cols-2">
                            ...
                            <div className="rounded-2xl border border-white/10 bg-white/[0.035] p-5">
                                ...
                                <p className="mt-4 text-base font-bold leading-7 text-white">
                                    Silver you can verify. Silver you can trust.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <section className="relative z-10 border-t border-white/10 bg-white/[0.025]">
                <div className="mx-auto max-w-7xl px-5 py-20 sm:px-8 lg:px-12 lg:py-28">
                    <div className="grid gap-10 lg:grid-cols-[1fr_1fr] lg:gap-16">
                        <div>
                            <p className="text-xs font-bold uppercase tracking-[0.3em] text-amber-300/75">
                                04 — Verify independently
                            </p>
                            <h2 className="mt-4 font-serif text-4xl tracking-tight text-white sm:text-5xl">
                                Use the official BIS Care App.
                            </h2>
                            <p className="mt-6 text-base leading-8 text-white/58">
                                Cross-check the final six-character HUID through the official
                                BIS Care App. The app’s “Verify HUID” feature is the
                                authoritative place to check the hallmark-linked item
                                information.
                            </p>
                            <a
                                href="https://www.bis.gov.in/bis-apps/?lang=en"
                            ...
                            >
                                Open official BIS Care information{" "}
                                <Icon name="external" className="h-4 w-4" />
                            </a>
                        </div>
                        <aside className="rounded-[2rem] border border-amber-300/20 bg-amber-300/[0.055] p-7 sm:p-9">
                            ...
                            <p className="mt-5 text-sm leading-7 text-white/58">
                                This OXYGOLD.AI page presents product and chain-of-custody
                                information declared by the listed businesses. It does not
                                replace the official BIS verification result. Always match the
                                HUID on the physical article with the result shown in the BIS
                                Care App.
                            </p>
                            <ul className="mt-6 space-y-3">
                                {[
                                    "Match the six-character HUID",
                                    "Confirm the purity/fineness",
                                    "Check the jeweller registration information",
                                ].map((item) => (
                                    <li
                                        key={item}
            ...
            <footer className="relative z-10 border-t border-white/10 bg-black/40">
                <div className="mx-auto flex max-w-7xl flex-col gap-6 px-5 py-8 sm:px-8 lg:flex-row lg:items-center lg:justify-between lg:px-12">
                    ...
                    <div className="flex flex-wrap gap-x-6 gap-y-3 text-xs font-semibold text-white/45">
                        ...
                        <a className="transition hover:text-amber-200" href="#top">
                            Back to top
                        </a>
                    </div>
                </div>
            ...
            {certificateOpen && (
                ...
                >
                    <div
                        className="flex h-[92vh] w-full flex-col overflow-hidden rounded-t-2xl border border-white/15 bg-[#111315] shadow-2xl sm:h-[90vh] sm:max-w-5xl sm:rounded-2xl"
                    ...
                    >
                        <div className="flex shrink-0 items-center justify-between border-b border-white/10 px-4 py-3 sm:px-5">
                            ...
                            <button
                                ...
                                className="grid h-9 w-9 place-items-center rounded-full border border-white/10 text-white/70 transition hover:bg-white/10 hover:text-white"
                            >
                        ...
                        <iframe
                            ...
                            title="Silver certificate preview"
