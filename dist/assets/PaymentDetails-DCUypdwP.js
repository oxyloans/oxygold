import{u,b as f,j as e}from"./index-C6ScifuI.js";const N=()=>{const r=u(),d=f(),l=d.state;console.log("PaymentDetails - location.state:",d.state),console.log("PaymentDetails - transactionData:",l);let a=l;if(!a){const o=sessionStorage.getItem("paymentSuccessData");o&&(a=JSON.parse(o),console.log("PaymentDetails - restored from sessionStorage:",a))}if(!a)return console.log("PaymentDetails - no data found, redirecting to portfolio"),r("/portfolio"),null;const i=(a==null?void 0:a.transactionId)||(a==null?void 0:a.orderId)||"";a!=null&&a.orderId||a!=null&&a.transactionId;const t=parseFloat(a==null?void 0:a.processingFee)||0,n=parseFloat(a==null?void 0:a.total)||0,c=n+t,p=parseFloat(a==null?void 0:a.grams)>0?parseFloat(a.grams).toFixed(6):(a==null?void 0:a.grams)||"0",m=parseFloat(a==null?void 0:a.goldRate)>0?parseFloat(a.goldRate).toLocaleString("en-IN",{maximumFractionDigits:2}):null,x=new Date().toLocaleString("en-IN",{day:"2-digit",month:"short",year:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0}),g=()=>{const o=`
