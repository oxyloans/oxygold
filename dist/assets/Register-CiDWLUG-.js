import{u as V,r as i,j as e,A as T}from"./index-C6ScifuI.js";const O=`${T}/oxygold-api/auth/userLoginOrRegister`,$=`${T}/oxygold-api/auth/createRole`,B=()=>{const h=V(),[j,v]=i.useState("phone"),[l,z]=i.useState(""),u="DIGITALGOld",[d,p]=i.useState(["","","","","",""]),[P,R]=i.useState(""),[f,a]=i.useState(""),[x,m]=i.useState(!1),[b,N]=i.useState(0),[w,I]=i.useState(!1),[C,k]=i.useState(!1),g=i.useRef([]);i.useEffect(()=>{if(b<=0)return;const t=setTimeout(()=>N(o=>o-1),1e3);return()=>clearTimeout(t)},[b]);const y=async()=>{var t,o;if(a(""),!/^[6-9]\d{9}$/.test(l)){a("Enter a valid 10-digit mobile number");return}m(!0);try{const s=await fetch(O,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({phoneNumber:l,registrationType:"mobile",userType:"Register",userRole:"user",whatsappNumber:""})}),n=await s.json();if(!s.ok)throw new Error((n==null?void 0:n.message)||(n==null?void 0:n.error)||"Failed to send OTP");R((n==null?void 0:n.mobileOtpSessionId)||((t=n==null?void 0:n.data)==null?void 0:t.mobileOtpSessionId)||((o=n==null?void 0:n.result)==null?void 0:o.mobileOtpSessionId)||""),k(!0),setTimeout(()=>k(!1),3e3),v("otp"),N(30),setTimeout(()=>{var c;return(c=g.current[0])==null?void 0:c.focus()},100)}catch(s){a(s.message||"Something went wrong. Please try again.")}finally{m(!1)}},E=async()=>{var o,s,n;a("");const t=d.join("");if(t.length<6){a("Enter the 6-digit OTP");return}m(!0);try{const c=await fetch(O,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({phoneNumber:l,registrationType:"mobile",userType:"Register",mobileOtpSessionId:P,mobileOtpValue:t,userRole:"user"})}),r=await c.json();if(!c.ok)throw new Error((r==null?void 0:r.message)||(r==null?void 0:r.error)||"Invalid OTP");const S=(r==null?void 0:r.token)||((o=r==null?void 0:r.data)==null?void 0:o.token)||((s=r==null?void 0:r.result)==null?void 0:s.token)||(r==null?void 0:r.accessToken)||((n=r==null?void 0:r.data)==null?void 0:n.accessToken)||"";localStorage.setItem("user",JSON.stringify({phone:l,isLoggedIn:!0,token:S,role:u})),await fetch($,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${S}`},body:JSON.stringify({role:u})}),I(!0),setTimeout(()=>{h("/portfolio")},1500)}catch(c){a(c.message||"Verification failed. Please try again.")}finally{m(!1)}},A=(t,o)=>{var n;if(!/^\d?$/.test(o))return;const s=[...d];s[t]=o,p(s),a(""),o&&t<5&&((n=g.current[t+1])==null||n.focus())},D=(t,o)=>{var s;o.key==="Backspace"&&!d[t]&&t>0&&((s=g.current[t-1])==null||s.focus())},L=t=>{var s;const o=t.clipboardData.getData("text").replace(/\D/g,"").slice(0,6);o.length===6&&(p(o.split("")),(s=g.current[5])==null||s.focus()),t.preventDefault()},G=()=>{p(["","","","","",""]),a(""),y()};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
      ...
      `}),e.jsx("div",{className:"lg-scene",children:e.jsxs("div",{className:"lg-card",children:[e.jsxs("div",{className:"lg-left",children:[e.jsx("div",{className:"lg-left-img"}),e.jsxs("div",{className:"lg-left-content",children:[e.jsx("div",{className:"lg-logo-name",children:"OXYGOLD.AI"}),e.jsxs("div",{children:[e.jsxs("div",{className:"lg-tagline",children:["Start Your",e.jsx("br",{}),e.jsxs("em",{children:[e.jsx("span",{className:"lg-gold-text",children:"Gold"})," & ",e.jsx("span",{className:"lg-silver-text",children:"Silver"})," Journey"]})]}),e.jsx("div",{className:"lg-left-desc",children:"Create your account to explore gold and silver products with live market rates and a secure experience."}),e.jsxs("div",{className:"lg-stats",children:[e.jsxs("div",{className:"lg-stat",children:[e.jsx("span",{className:"lg-stat-val",children:"999.9"}),e.jsx("span",{className:"lg-stat-lbl",children:"Purity"})]}),e.jsxs("div",{className:"lg-stat",children:[e.jsx("span",{className:"lg-stat-val",children:"₹100"}),e.jsx("span",{className:"lg-stat-lbl",children:"Market Rates"})]}),e.jsxs("div",{className:"lg-stat",children:[e.jsx("span",{className:"lg-stat-val",children:"Secure"}),e.jsx("span",{className:"lg-stat-lbl",children:"Experience"})]})]})]})]})]}),e.jsxs("div",{className:"lg-right",children:[j==="phone"&&e.jsxs("div",{className:"lg-animate",children:[e.jsx("div",{className:"lg-form-title",children:"Create account"}),e.jsx("div",{className:"lg-form-sub",children:"Enter your mobile to get started"}),e.jsxs("div",{className:"lg-field",children:[e.jsx("label",{className:"lg-lbl",children:"Mobile Number"}),e.jsxs("div",{className:"lg-phone-wrap",children:[e.jsx("span",{className:"lg-phone-prefix",children:"+91"}),e.jsx("input",{className:"lg-phone-input",type:"number",placeholder:"Enter 10-digit mobile number",value:l,onChange:t=>{z(t.target.value.slice(0,10)),a("")},onKeyDown:t=>t.key==="Enter"&&y()})]})]}),e.jsx("input",{type:"hidden",value:u}),f&&e.jsx("div",{className:"lg-error",children:f}),e.jsx("button",{className:"lg-btn",onClick:y,disabled:x,children:x?e.jsx("span",{className:"lg-spin"}):"Send OTP →"}),e.jsxs("div",{className:"lg-divider",children:[e.jsx("div",{className:"lg-divider-line"}),e.jsx("span",{className:"lg-divider-txt",children:"OR"}),e.jsx("div",{className:"lg-divider-line"})]}),e.jsxs("div",{className:"lg-footer",children:["Already have an account?"," ",e.jsx("button",{className:"lg-link",onClick:()=>h("/login"),children:"Sign in"})]}),e.jsx("button",{className:"lg-back",onClick:()=>h("/"),children:"← Back to home"})]}),j==="otp"&&e.jsxs("div",{className:"lg-animate",children:[e.jsx("div",{className:"lg-form-title",children:"Verify OTP"}),e.jsx("div",{className:"lg-form-sub",children:"Code sent to your mobile"}),C&&e.jsxs("div",{className:"lg-success",children:[e.jsx("span",{className:"lg-success-icon",children:"✓"}),"OTP sent to +91 ",l]}),e.jsxs("button",{className:"lg-change-phone",onClick:()=>{v("phone"),p(["","","","","",""]),a("")},children:["← +91 ",l]}),e.jsxs("div",{className:"lg-field",children:[e.jsx("label",{className:"lg-lbl",children:"Enter 6-digit OTP"}),e.jsx("div",{className:"lg-otp-row",onPaste:L,children:d.map((t,o)=>e.jsx("input",{ref:s=>{g.current[o]=s},className:`lg-otp-box ${t?"filled":""}`,type:"number",inputMode:"numeric",maxLength:1,value:t,onChange:s=>A(o,s.target.value.slice(-1)),onKeyDown:s=>D(o,s)},o))}),e.jsxs("div",{className:"lg-otp-hint",children:["Didn't receive it?"," ",b>0?e.jsxs(e.Fragment,{children:["Resend in ",e.jsxs("span",{children:[b,"s"]})]}):e.jsx("button",{className:"lg-resend-btn",onClick:G,children:"Resend OTP"})]})]}),w&&e.jsxs("div",{className:"lg-success",children:[e.jsx("span",{className:"lg-success-icon",children:"✓"}),"Registration successful! Redirecting..."]}),f&&e.jsx("div",{className:"lg-error",children:f}),e.jsx("button",{className:"lg-btn",onClick:E,disabled:x||d.join("").length<6||w,children:x?e.jsx("span",{className:"lg-spin"}):w?"Success!":"Verify & Continue →"})]})]})]})})]})};export{B as default};
