import{u as R,b as D,r as i,j as e,d as N,A as j}from"./index-BDxZysMK.js";import{g as $}from"./userUtils-tELdYHus.js";const G=()=>{const s=R(),h=D().state,[g,m]=i.useState(1),[f,S]=i.useState(""),[F,I]=i.useState("PENDING"),[k,x]=i.useState("Processing your sell order...");if(!h)return s("/sell-gold"),null;const{transactionId:t,beneficiaryId:b,status:v,amount:o,grams:c,sellRate:a,bankDetails:l,message:E,userId:y}=h,T=`${j}/oxygold-api/digital-gold/sell/execute`,A=`${j}/oxygold-api/digital-gold/payout/status`;return i.useEffect(()=>{const d=y||$();if(!d){s("/login");return}const w=setTimeout(async()=>{try{m(1),x("Executing sell order...");const n=await N(`${T}?txnId=${t}`,{method:"POST"});if(console.log("Sell Execute Response:",n),n.success&&n.data){const{transferId:p,status:U,message:P}=n.data;S(p),m(2),x(P||"Bank payout initiated..."),setTimeout(async()=>{try{m(3),x("Checking payment status...");const r=await N(`${A}?transferId=${p}&txnId=${t}`,{method:"GET"});if(console.log("Payout Status Response:",r),r.success&&r.data){const{status:u,message:M}=r.data;I(u),setTimeout(()=>{s("/sell-success",{state:{transactionId:t,transferId:p,beneficiaryId:b,status:u,amount:o,grams:c,sellRate:a,bankDetails:l,message:M,userId:d,paymentStatus:u==="UNKNOWN"?"FAILED":u,pergramSellingPrice:a,purchaseType:"GRAMS",paymentMode:"BANK",productId:4}})},2e3)}else throw new Error("Failed to check payment status")}catch(r){console.error("Status check failed:",r),s("/sell-success",{state:{transactionId:t,transferId:p,beneficiaryId:b,status:"FAILED",amount:o,grams:c,sellRate:a,bankDetails:l,message:"Payment status check failed",userId:d,paymentStatus:"FAILED",pergramSellingPrice:a,purchaseType:"GRAMS",paymentMode:"BANK",productId:4}})}},3e3)}else throw new Error(n.message||"Sell execution failed")}catch(n){console.error("Transaction processing failed:",n),s("/sell-success",{state:{transactionId:t,beneficiaryId:b,status:"FAILED",amount:o,grams:c,sellRate:a,bankDetails:l,message:"Transaction processing failed",userId:d,paymentStatus:"FAILED",pergramSellingPrice:a,purchaseType:"GRAMS",paymentMode:"BANK",productId:4}})}},1e3);return()=>clearTimeout(w)},[s,t,v,o,c,a,l,E,y]),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
      ...
      `}),e.jsxs("div",{className:"page",children:[e.jsx("section",{className:"banner",children:e.jsxs("div",{className:"banner-in",children:[e.jsx("button",{className:"back-btn",onClick:()=>s("/bank-account"),children:"←"}),e.jsx("span",{className:"banner-sep"}),e.jsx("span",{className:"banner-title",children:"Processing Your Sell Order"}),e.jsx("span",{className:"banner-sep"}),e.jsx("span",{className:"banner-sub",children:"Please wait..."})]})}),e.jsx("main",{className:"main",children:e.jsxs("div",{className:"content",children:[e.jsx("div",{className:"spinner-wrap",children:e.jsx("div",{className:"spinner",children:e.jsx("div",{className:"spinner-ring"})})}),e.jsx("h1",{className:"title",children:"Processing Your Sell Order"}),e.jsx("p",{className:"subtitle",children:k}),e.jsxs("p",{className:"subtitle",children:["Transaction ID: ",t||"Generating..."]}),f&&e.jsxs("p",{className:"subtitle",children:["Transfer ID: ",f]}),e.jsxs("div",{className:"steps",children:[e.jsxs("div",{className:`step${g>=1?"":" inactive"}`,children:[e.jsx("div",{className:"step-dot"}),e.jsx("span",{children:"Executing sell order"})]}),e.jsxs("div",{className:`step${g>=2?"":" inactive"}`,children:[e.jsx("div",{className:"step-dot"}),e.jsx("span",{children:"Initiating bank payout"})]}),e.jsxs("div",{className:`step${g>=3?"":" inactive"}`,children:[e.jsx("div",{className:"step-dot"}),e.jsx("span",{children:"Verifying payment status"})]})]})]})})]})]})};export{G as default};
