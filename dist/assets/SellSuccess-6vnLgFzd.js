import{u as p,b as m,j as e}from"./index-C6ScifuI.js";const b=()=>{const s=p(),l=m().state;if(!l)return s("/sell-gold"),null;const{transactionId:n,amount:o,grams:i,sellRate:t,paymentStatus:r,pergramSellingPrice:d}=l,c=d||t,a=r==="FAILED"||r==="UNKNOWN",x=new Date().toLocaleString("en-IN",{day:"2-digit",month:"short",year:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0}).replace(" at ",", ");return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
