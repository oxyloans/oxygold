import{u as T,b as L,r as i,d as E,A as R,j as e}from"./index-C6ScifuI.js";const F=`${R}/oxygold-api/digital-gold/payments/webhook`,$=({transactionData:S})=>{const l=T(),x=L(),[M,C]=i.useState(!1),[N,g]=i.useState(null),[w,m]=i.useState(!0),[j,I]=i.useState(0),[s,f]=i.useState(null);i.useEffect(()=>{var p,a;const o=new URLSearchParams(x.search).get("order_id");if(o){const t=sessionStorage.getItem("paymentSuccessData");if(t){const d={...JSON.parse(t),orderId:o,transactionId:o};console.log("[PaymentSuccess] Restored from sessionStorage:",{grams:d.grams,goldRate:d.goldRate,total:d.total}),f(d)}else console.warn("[PaymentSuccess] sessionStorage empty, using URL orderId only"),f({orderId:o,transactionId:o});return}const b=x.state||S||null;if(b){sessionStorage.setItem("paymentSuccessData",JSON.stringify(b)),f(b);return}const u=sessionStorage.getItem("paymentSuccessData");if(u){const t=JSON.parse(u),r=(a=(p=JSON.parse(localStorage.getItem("user")||"{}"))==null?void 0:p.data)==null?void 0:a.userId;if(r&&t.userId&&t.userId!==r){sessionStorage.removeItem("paymentSuccessData"),l("/buy-gold");return}f(t)}else l("/buy-gold")},[x.state,x.search,S]);const h=(s==null?void 0:s.transactionId)||(s==null?void 0:s.orderId)||"";s!=null&&s.orderId||s!=null&&s.transactionId;const v=parseFloat(s==null?void 0:s.processingFee)||0,k=(parseFloat(s==null?void 0:s.total)||0)+v,y=parseFloat(s==null?void 0:s.grams)>0?parseFloat(s.grams).toFixed(6):(s==null?void 0:s.grams)||"0",P=parseFloat(s==null?void 0:s.goldRate)>0?parseFloat(s.goldRate).toLocaleString("en-IN",{maximumFractionDigits:2}):null;console.log("PaymentSuccess - transactionData:",s),console.log("PaymentSuccess - calculated values:",{txnId:h,gramsDisplay:y,totalAmount:k,goldRateDisplay:P}),i.useEffect(()=>{if(!s)return;const c=s.orderId||s.transactionId||"";if(c)A(c);else{const o=s.status;g(o==="SUCCESS"||o==="success"?"success":"failure"),m(!1)}},[s]);const A=async c=>{var p;m(!0);for(let a=1;a<=10;a++)try{I(a);const t=await E(`${F}?order_id=${c}`,{method:"POST"}),r=t.status||((p=t.data)==null?void 0:p.status)||"";if(console.log(`[PaymentSuccess] Poll ${a} for ${c}: status=${r}`),r==="SUCCESS"){g("success"),m(!1);return}if(r==="FAILED"||r==="FAILURE"||r==="CANCELLED"){g("failure"),m(!1);return}a<10&&await new Promise(d=>setTimeout(d,3e3))}catch(t){console.error(`[PaymentSuccess] Poll ${a} error:`,t),a<10&&await new Promise(r=>setTimeout(r,3e3))}console.warn("[PaymentSuccess] Still PENDING after max attempts");const u=s==null?void 0:s.status;g(u==="SUCCESS"||u==="success"?"success":"failure"),m(!1)};if(w)return e.jsx("div",{style:{minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"Inter, sans-serif"},children:e.jsxs("div",{style:{textAlign:"center"},children:[e.jsx("div",{style:{width:"40px",height:"40px",border:"4px solid #f3f3f3",borderTop:"4px solid #d9a020",borderRadius:"50%",animation:"spin 1s linear infinite",margin:"0 auto 16px"}}),e.jsx("p",{style:{color:"#1a1a2e",fontWeight:600,marginBottom:6},children:"Verifying payment..."}),j>1&&e.jsxs("p",{style:{color:"#999",fontSize:"0.8rem"},children:["Still checking... attempt ",j,"/10"]}),e.jsx("style",{children:"@keyframes spin { 0% { transform: rotate(0deg); } 100% { transform: rotate(360deg); } }"})]})});const n=N==="success";return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
